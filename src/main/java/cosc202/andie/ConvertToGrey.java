 ...
 *
 * <p>
 * The images produced by this operation are still technically colour images, in
 * that they have red, green, and blue values, but each pixel has equal values
 * for red, green, and blue giving a shade of grey.
 * </p>
 *
 * <p>
...
public class ConvertToGrey implements ImageOperation, java.io.Serializable {
     ...
     * weighted average that reflects the human visual system's sensitivity to
     * different wavelengths -- we are most sensitive to green light and least
     * to blue.
     * </p>
     *
